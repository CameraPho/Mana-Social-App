...
const FONT = "'Bebas Neue', 'Space Grotesk', -apple-system, BlinkMacSystemFont, sans-serif"
...
const LIGHT_COLORS = {
  ...
  bg: '#F0F4FF', white: '#FFFFFF', muted: '#6B7A9A',
  text: '#0B132B', border: 'rgba(36,60,139,0.12)', green: '#10b981',
